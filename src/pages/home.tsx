    ...
    <div className="bg-[#0a0a0a] text-white min-h-screen" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 z-10" style={{ background: "linear-gradient(to right, rgba(10,10,10,0.95) 10%, rgba(10,10,10,0.4) 100%)" }} />
          <div className="absolute inset-0 opacity-40" style={{ backgroundImage: "url('/hero-bg.jpg')", backgroundSize: "cover", backgroundPosition: "30% center" }} />
        </div>
